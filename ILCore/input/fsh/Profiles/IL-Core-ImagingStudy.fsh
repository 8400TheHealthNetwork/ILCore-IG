...
* procedureCode ^comment = "Accessing this valueset requires Loinc userName and password. Thus, it is presented here. The original value-set can be found [here](http://loinc.org/vs/loinc-rsna-radiology-playbook)"
