// Instance: patient-TEST-extension-location
...
// // * contact[parent].extension[purpose].valueCodeableConcept = http://terminology.hl7.org/CodeSystem/v2-0131#EP "Emergency contact person"