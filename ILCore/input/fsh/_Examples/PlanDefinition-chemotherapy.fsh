Alias: $indications = http://http://fhir.community-emr.co.il/fhir/CodeSystem/indications
...
* relatedArtifact[=].url = "http://www.http://fhir.community-emr.co.il/professionals/physician_gls/PDF/kidney.pdf"
