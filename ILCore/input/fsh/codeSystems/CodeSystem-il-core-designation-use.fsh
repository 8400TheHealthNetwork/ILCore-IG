...
* #local-policy-interpretation "Local policy interpretation" "A designation that provides the local policy interpretation or policy-specific definition of a concept."
