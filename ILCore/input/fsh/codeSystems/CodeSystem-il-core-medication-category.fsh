...
* #community-other "Community Care/Long Term Care/Home" "Includes medications to be administered or consumed in community care settings (this would include long term care or nursing homes, hospices, patient’s home, and home hospitalization etc.)"
* #discharge "Discharge" "Includes  medications to be administered or consumed after the patient is released from a facility"
