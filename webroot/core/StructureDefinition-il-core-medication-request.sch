...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest">
      <sch:assert test="count(f:extension[@url = 'http://fhir.health.gov.il/StructureDefinition/ext-recorded-time']) &lt;= 1">extension with URL = 'http://fhir.health.gov.il/StructureDefinition/ext-recorded-time': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.health.gov.il/StructureDefinition/ext-narcotic-medication']) &lt;= 1">extension with URL = 'http://fhir.health.gov.il/StructureDefinition/ext-narcotic-medication': maximum cardinality of 'extension' is 1</sch:assert>
